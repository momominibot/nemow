...
(function(){
  ...
  var SCREENS=[
    ...
    ['Body systems',[['stress.html','self_improvement','Stress'],['breathe.html','air','Breathe'],['intimacy.html','favorite','Intimacy'],['exercise.html','fitness_center','Exercise'],['diet.html','restaurant','Diet'],['sleep.html','bedtime','Sleep'],['vascular.html','cardiology','Vascular'],['ppg.html','fingerprint','Measure']]],
    ['Nutrition',[['food-scan.html','photo_camera','Food Scan'],['nutrients.html','medication','Nutrients'],['supplements.html','grocery','Supplements'],['hydration.html','water_full','Hydration']]],
    ...
    ['Health',[['reports.html','description','Medical Reports']]],
