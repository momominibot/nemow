...
(function(){
  ...
  var SCREENS=[
    ...
    ['Body systems',[['wellness-checkin.html','spa','Wellness Score'],['sleep-diary.html','bedtime','Sleep Diary'],['stress-checkin.html','self_improvement','Stress Check'],['breathwork.html','air','Breathwork'],['intimacy.html','favorite','Intimacy'],['exercise.html','fitness_center','Exercise'],['diet.html','restaurant','Diet'],['sleep.html','bedtime','Sleep'],['vascular.html','cardiology','Vascular'],['ppg.html','fingerprint','Measure']]],
    ...
    ['Nutrition',[['food-scan.html','photo_camera','Food Scan'],['nutrition-scanner.html','barcode_reader','UPF Scanner'],['medas14.html','nutrition','Mediterranean Score'],['nutrients.html','medication','Nutrients'],['supplements.html','grocery','Supplements'],['hydration.html','water_full','Hydration']]],
